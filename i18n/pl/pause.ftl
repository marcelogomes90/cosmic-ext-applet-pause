...
reminder-eyes = Oczy
reminder-eyes-detail = Daj odpocząć oczom
reminder-water = Woda
reminder-water-detail = Pamiętaj o nawodnieniu
...
reminder-wrists-detail = Rozluźnij nadgarstki

notify-eyes-title = Daj odpocząć oczom
notify-eyes-body = Oderwij na chwilę wzrok od ekranu.
notify-water-title = Napij się wody
...
nothing-scheduled = Brak włączonych przypomnień
...
action-pause-1h = 1h
action-pause-2h = 2h
action-until-resumed = Bez końca
action-reset-timers = Zresetuj liczniki
...
duration-hours-minutes = { $hours } godz. { $minutes } min
